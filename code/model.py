...
class Transformer(nn.Module):
    ...
    def forward(self, x):
        ...
        return latent, pre, attn_weights_1, (output1, output2, output3, output4, cls1, cls2, cls3, cls4)
...
def scTrans_model(num_classes, num_genes, mask_1, mask_2, mask_3, mask_4, embed_dim=60, depth=2, num_heads=4, has_logits: bool = True):
